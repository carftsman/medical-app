...
const DoctorInfoWomen = ({ image, name, specialization, experience, rating, consultationFee }) => {
    return (
        <View>
            ...
            <View style={styles.statsRow} >
                <View style={styles.statItem} >
                    ...
                    <View>
                        <Text style={styles.statText} >Treated
                            <Text style={{ color: '#F47FBB', fontWeight: '600' }}
                            > 2800
                            </Text>
                        </Text>
                ...
                <View style={styles.statItem} >
                    ...
                    <View>
                        ...
                        <Text>
                            <FontAwesome name="rupee" size={15} color= "#F47FBB" />
                            <Text style={{ fontWeight: '600', fontSize: 15,color: '#F47FBB' }}> {consultationFee || 200}/-</Text>
                        </Text>
                    </View>
                </View>
            </View>
...
export default DoctorInfoWomen;
