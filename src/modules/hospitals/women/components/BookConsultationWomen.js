...
const BookConsultationWomen = ({ visible, onClose, bookAppointmentForSelf, doctorId }) => {
            ...
            <View style={styles.overlay}>
                <View style={styles.container}>
                    ...
                    <View style={styles.cards}>
                        ...
                        >
                            <Icon name="account-outline" size={scale(24)} color={selectedType === 'SELF' ? '#F47FBB' : '#000'} />
                        ...
                        >
                            <Icon name="account-multiple-outline" size={scale(24)} color={selectedType === 'SELF' ? '#000' : '#F47FBB'} />
                            <Text style={[styles.cardTitle,
...
export default BookConsultationWomen;
