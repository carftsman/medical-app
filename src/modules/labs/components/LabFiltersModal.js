...
//   // Load previous selected filters when modal opens
//   useEffect(() => {
//     if (visible) {
//       setSortBy(initialFilters.sortBy || "");
//       setRadius(initialFilters.radius || null);
//       setMinRating(initialFilters.minRating || null);
//       setMinFee(initialFilters.minFee || null);
//       setMaxFee(initialFilters.maxFee || null);
//     }
//   }, [visible]);
...
//               {renderOption("Distance", "distance", sortBy, setSortBy)}
//               {renderOption("Rating", "rating", sortBy, setSortBy)}
//               {renderOption("Fee", "fee", sortBy, setSortBy)}
//             </View>

//             {/* DISTANCE */}
//             <Text style={styles.sectionTitle}>Distance (KM)</Text>
//             <View style={styles.row}>
//               {renderOption("3 KM", 3, radius, setRadius)}
//               {renderOption("5 KM", 5, radius, setRadius)}
//               {renderOption("10 KM", 10, radius, setRadius)}
//             </View>

//             {/* RATING */}
//             <Text style={styles.sectionTitle}>Minimum Rating</Text>
//             <View style={styles.row}>
//               {renderOption("3+", 3, minRating, setMinRating)}
//               {renderOption("4+", 4, minRating, setMinRating)}
//               {renderOption("4.5+", 4.5, minRating, setMinRating)}
//             </View>
...
//                 style={[
//                   styles.optionButton,
//                   minFee === 0 && maxFee === 500 && styles.selectedOption,
//                 ]}
//                 onPress={() => {
//                   setMinFee(0);
//                   setMaxFee(500);
...
//                   style={[
//                     styles.optionText,
//                     minFee === 0 && maxFee === 500 && styles.selectedOptionText,
//                   ]}
//                 >
//                   ₹0 - ₹500
//                 </Text>
...
//                 style={[
//                   styles.optionButton,
//                   minFee === 500 && maxFee === 1000 && styles.selectedOption,
//                 ]}
//                 onPress={() => {
//                   setMinFee(500);
//                   setMaxFee(1000);
...
//                 style={[
//                   styles.optionButton,
//                   minFee === 1000 && maxFee === 5000 && styles.selectedOption,
//                 ]}
//                 onPress={() => {
//                   setMinFee(1000);
//                   setMaxFee(5000);
