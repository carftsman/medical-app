    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <TouchableOpacity onPress={() => navigation.navigate("LabTabNavigation")}>
            ...
            <Text style={styles.subtitle}>
                Your lab technician will be assigned and will arrive at your location
                as scheduled.
            </Text>
            ...
            <View style={styles.bottomRow}>
                <TouchableOpacity style={styles.secondaryButton} onPress={handleCallPress}>
